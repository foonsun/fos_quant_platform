    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symbol1', models.CharField(default='', help_text='请填写该交易所的交易对例如BTC/USDT', max_length=20, verbose_name='交易对2')),
                ('symbol2', models.CharField(default='', help_text='请填写该交易所的交易对例如BTC/USDT', max_length=20, verbose_name='交易对3')),
                ('base_volume', models.FloatField(default=0, help_text='请填写需要赚的币的数量', verbose_name='货币数量')),
