...
print(encode_rabbit_password_hash('CAD5089B', 'quant001@'))
print(decode_rabbit_password_hash('ytUIm0w94ROqSkthIyZBP6xxfzdHFQoB2D6aVUcNchoib6g3'))
print(check_rabbit_password('quant001@', 'ytUIm0w94ROqSkthIyZBP6xxfzdHFQoB2D6aVUcNchoib6g3'))